...
function normalizeReaderSettings(raw: Record<string, unknown> | null | undefined): ReaderSettings {
      ...
      <div className="study-panel-content">
        <section className="mystuff-section mystuff-account-section">
          ...
          <AuthPanel
            ...
            error={authError}
            mode={authMode}
            profile={accountProfile ? { email: accountProfile.email ?? '', display_name: accountProfile.display_name ?? null } : null}
