...
function normalizeReaderSettings(raw: Partial<ReaderSettings> | null | undefined): ReaderSettings {
  return {
    fontScale: raw?.fontScale === 'large' || raw?.fontScale === 'xlarge' ? raw.fontScale : 'comfortable',
    lineHeight: raw?.lineHeight === 'airy' ? 'airy' : 'relaxed',
            ...
            <div className="settings-controls">
              <label className="settings-field">
                ...
                <select
                  ...
                  onChange={event => setReaderSettings(prev => ({ ...prev, fontScale: event.target.value as ReaderSettings['fontScale'] }))}
                >
              ...
              <label className="settings-field">
                ...
                <select
                  ...
                  onChange={event => setReaderSettings(prev => ({ ...prev, lineHeight: event.target.value as ReaderSettings['lineHeight'] }))}
                >
