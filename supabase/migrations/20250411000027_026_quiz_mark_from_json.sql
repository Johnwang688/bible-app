...
INSERT INTO quiz_question_bank (book_number, chapter, difficulty_stage, prompt, choices_json, correct_answer, explanation)
SELECT 41, 6, 1, 'Where was Jesus rejected in Mark 6?', '["Nazareth", "Jerusalem", "Bethany", "Tyre"]'::jsonb, 'Nazareth', 'Mark 6:1-6 describes Jesus being rejected in Nazareth.'
WHERE NOT EXISTS (
  SELECT 1 FROM quiz_question_bank q
  WHERE q.book_number = 41
    AND q.chapter = 6
    AND q.difficulty_stage = 1
    AND q.prompt = 'Where was Jesus rejected in Mark 6?'
);
...
INSERT INTO quiz_question_bank (book_number, chapter, difficulty_stage, prompt, choices_json, correct_answer, explanation)
SELECT 41, 9, 1, 'Who appeared with Jesus at the transfiguration in Mark 9?', '["Moses and Elijah", "Abraham and David", "Isaiah and Jeremiah", "John and James"]'::jsonb, 'Moses and Elijah', 'Mark 9:4 says Moses and Elijah appeared with Jesus.'
WHERE NOT EXISTS (
  SELECT 1 FROM quiz_question_bank q
  WHERE q.book_number = 41
    AND q.chapter = 9
    AND q.difficulty_stage = 1
    AND q.prompt = 'Who appeared with Jesus at the transfiguration in Mark 9?'
);
...
INSERT INTO quiz_question_bank (book_number, chapter, difficulty_stage, prompt, choices_json, correct_answer, explanation)
SELECT 41, 6, 1, 'Where was Jesus rejected in Mark 6?', '["Nazareth", "Jerusalem", "Bethany", "Tyre"]'::jsonb, 'Nazareth', 'Jesus was rejected in his hometown of Nazareth.'
WHERE NOT EXISTS (
  SELECT 1 FROM quiz_question_bank q
  WHERE q.book_number = 41
    AND q.chapter = 6
...
INSERT INTO quiz_question_bank (book_number, chapter, difficulty_stage, prompt, choices_json, correct_answer, explanation)
SELECT 41, 9, 1, 'Who appeared with Jesus at the transfiguration in Mark 9?', '["Moses and Elijah", "Abraham and David", "Isaiah and Jeremiah", "John and Andrew"]'::jsonb, 'Moses and Elijah', 'Moses and Elijah appeared with Jesus on the mountain.'
WHERE NOT EXISTS (
  SELECT 1 FROM quiz_question_bank q
  WHERE q.book_number = 41
    AND q.chapter = 9
...
INSERT INTO quiz_question_bank (book_number, chapter, difficulty_stage, prompt, choices_json, correct_answer, explanation)
SELECT 41, 13, 1, 'What did Jesus predict about the temple in Mark 13?', '["Not one stone would be left upon another", "It would become Rome''s palace", "It would stand forever unchanged", "It would be rebuilt in three days by Herod"]'::jsonb, 'Not one stone would be left upon another', 'Jesus foretold the destruction of the temple.'
WHERE NOT EXISTS (
  SELECT 1 FROM quiz_question_bank q
  WHERE q.book_number = 41
    AND q.chapter = 13
