...
INSERT INTO quiz_question_bank (book_number, chapter, difficulty_stage, prompt, choices_json, correct_answer, explanation)
SELECT 40, 18, 1, 'According to Matthew 18, who is greatest in the Kingdom of Heaven?', '["One who humbles himself like a little child", "The oldest disciple", "The one who speaks most often", "The one with the most wealth"]'::jsonb, 'One who humbles himself like a little child', 'Matthew 18:3-4 says greatness belongs to the one who becomes humble like a child.'
WHERE NOT EXISTS (
  SELECT 1 FROM quiz_question_bank q
  WHERE q.book_number = 40
    AND q.chapter = 18
    AND q.difficulty_stage = 1
    AND q.prompt = 'According to Matthew 18, who is greatest in the Kingdom of Heaven?'
);
...
INSERT INTO quiz_question_bank (book_number, chapter, difficulty_stage, prompt, choices_json, correct_answer, explanation)
SELECT 40, 21, 1, 'What animal did Jesus ride into Jerusalem in Matthew 21?', '["A donkey", "A horse", "A camel", "A chariot"]'::jsonb, 'A donkey', 'Matthew 21:5-7 presents Jesus entering Jerusalem on a donkey.'
WHERE NOT EXISTS (
  SELECT 1 FROM quiz_question_bank q
  WHERE q.book_number = 40
    AND q.chapter = 21
    AND q.difficulty_stage = 1
    AND q.prompt = 'What animal did Jesus ride into Jerusalem in Matthew 21?'
);
...
INSERT INTO quiz_question_bank (book_number, chapter, difficulty_stage, prompt, choices_json, correct_answer, explanation)
SELECT 40, 26, 1, 'Who agreed to betray Jesus for silver in Matthew 26?', '["Judas Iscariot", "Peter", "Caiaphas", "Pilate"]'::jsonb, 'Judas Iscariot', 'Matthew 26:14-15 says Judas agreed to betray Jesus for thirty pieces of silver.'
WHERE NOT EXISTS (
  SELECT 1 FROM quiz_question_bank q
  WHERE q.book_number = 40
    AND q.chapter = 26
    AND q.difficulty_stage = 1
    AND q.prompt = 'Who agreed to betray Jesus for silver in Matthew 26?'
);
...
INSERT INTO quiz_question_bank (book_number, chapter, difficulty_stage, prompt, choices_json, correct_answer, explanation)
SELECT 40, 18, 1, 'According to Matthew 18, who is greatest in the Kingdom of Heaven?', '["One who becomes like a little child", "The richest disciple", "The chief priest", "The oldest apostle"]'::jsonb, 'One who becomes like a little child', 'Jesus placed a little child in their midst and taught that humility like a child marks greatness in the Kingdom.'
WHERE NOT EXISTS (
  SELECT 1 FROM quiz_question_bank q
  WHERE q.book_number = 40
    AND q.chapter = 18
...
INSERT INTO quiz_question_bank (book_number, chapter, difficulty_stage, prompt, choices_json, correct_answer, explanation)
SELECT 40, 21, 1, 'What animal did Jesus ride into Jerusalem in Matthew 21?', '["A donkey", "A horse", "A camel", "A mule cart"]'::jsonb, 'A donkey', 'Jesus entered Jerusalem riding on a donkey, fulfilling prophecy.'
WHERE NOT EXISTS (
  SELECT 1 FROM quiz_question_bank q
  WHERE q.book_number = 40
    AND q.chapter = 21
...
INSERT INTO quiz_question_bank (book_number, chapter, difficulty_stage, prompt, choices_json, correct_answer, explanation)
SELECT 40, 26, 1, 'Who agreed to betray Jesus for silver in Matthew 26?', '["Judas Iscariot", "Peter", "John", "Pilate"]'::jsonb, 'Judas Iscariot', 'Judas went to the chief priests and agreed to betray Jesus for thirty pieces of silver.'
WHERE NOT EXISTS (
  SELECT 1 FROM quiz_question_bank q
  WHERE q.book_number = 40
    AND q.chapter = 26
